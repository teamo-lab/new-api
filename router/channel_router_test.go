...
func TestChannelStatusRoutesUseOperatePermission(t *testing.T) {
	...
	assertChannelRoutePermission(t, http.MethodPost, "/status/:id/auto_disabled", authz.ChannelOperate, controller.AutoDisableChannel)
	assertChannelRoutePermission(t, http.MethodPost, "/status/:id/enabled", authz.ChannelOperate, controller.EnableChannel)
