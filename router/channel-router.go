...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/status/:id/auto_disabled", permission: authz.ChannelOperate, handler: controller.AutoDisableChannel},
	{method: http.MethodPost, path: "/status/:id/enabled", permission: authz.ChannelOperate, handler: controller.EnableChannel},
